...
public class API_Main implements Runnable {      
	...
	public void run() {
		...
		try {
			...
			int state = 0;
			String strParams = "", line = "";
			HashMap<Integer, String> cognitivMap = new HashMap<Integer, String>();
			HashMap<String, Function<Pointer, Float>> affectivMap = new HashMap<String, Function<Pointer, Float>>();
			HashMap<String, Function<Pointer, Number>> expressivMap = new HashMap<String, Function<Pointer, Number>>();
			...
			//cognitiv
			br = new BufferedReader(new FileReader((new File("CognitivEvents.txt")).getAbsolutePath()));
